          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                    child: Divider(
                        color: Colors.white38, indent: 30, endIndent: 10)),
                Text("login with", style: TextStyle(color: Colors.white54)),
                Expanded(
                    child: Divider(
                        color: Colors.white38, indent: 10, endIndent: 30)),
              ],
            ),
            const SizedBox(height: 20),
            Row(
  ...
  return GestureDetector(
    onTap: () {
      ...
      if (label == "Login") {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const Login()), // ✅ diarahkan ke halaman Login
        );
      }
    },
    child: Container(
